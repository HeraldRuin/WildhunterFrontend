...
<template>
  <article class="base-hotel-card">
    ...
    <div class="base-hotel-card__body">
      ...
      <div class="base-hotel-card__footer">
        ...
        <div class="base-hotel-card__actions">
          <button type="button" class="base-hotel-card__btn base-hotel-card__btn--info">
            Доступные номера
          </button>
          <button type="button" class="base-hotel-card__btn base-hotel-card__btn--warning">
            Редактировать
          </button>
          <button type="button" class="base-hotel-card__btn base-hotel-card__btn--info">
            Клонировать
